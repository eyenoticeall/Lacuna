...
CONTRACT_PATH = Path(__file__).parents[1] / "fixtures" / "public-api-v0.2.json"
...
def test_root_exports_match_the_v0_2_contract() -> None:
    assert lacuna.__all__ == _contract()["root_exports"]


def test_public_module_exports_match_the_v0_2_contract() -> None:
