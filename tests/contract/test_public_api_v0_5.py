...
CONTRACT_PATH = Path(__file__).parents[1] / "fixtures" / "public-api-v0.5.json"
...
def test_root_exports_preserve_the_v0_5_contract() -> None:
    expected = _contract()["root_exports"]
    assert isinstance(expected, list)
    assert set(expected).issubset(lacuna.__all__)


def test_public_module_exports_preserve_the_v0_5_contract() -> None:
...
def test_new_public_call_signatures_match_the_v0_5_contract() -> None:
...
def test_v0_5_contract_declares_its_compatibility_chain() -> None:
