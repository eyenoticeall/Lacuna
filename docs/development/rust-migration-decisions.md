...
| R-08 | MEASURED | PBO/CSCV | [`c031c82` baseline](../../benchmarks/native-migration/r08-baseline-c031c82.json), [`7bbdf55` reference](../../benchmarks/native-migration/r08-reference-7bbdf55.json) | 210 rows, 12 strategies, 14 partitions, 3,432 combinations | 730.09 ms / 499.25 ms optimized / native spike pending | exact structural differential tests and numerical agreement within 1e-12 for mean and Sharpe | Partition moments remove repeated row slicing, but the reducer remains 52% of public latency. A compact built-in-statistic native spike is admitted to evaluation; projection cost remains in the gate. |
