...
| F-03a compact internal carriers | MEASURED | `957cc16`, `010b873`, `97db28e` | cost components and resample values/indices/offsets | contiguous carriers are integrated behind existing cost and scalar-bootstrap APIs; a memory-heavy joint vectorization was removed | Compact CV carrier work remains conditional on R-05 admission; public projection cost must be included. |
