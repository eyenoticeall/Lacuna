...
Python package metadata normalizes a candidate such as `0.4.0-rc.1` to `0.4.0rc1`; stable package
metadata is `0.4.0`. The release verifier owns this mapping and prevents the two surfaces from
drifting.
